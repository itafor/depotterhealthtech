...
?><?php require("includes/header.php"); ?>  
              ...
              ?>
                ...
                <div class="page">
                    ...
                    <table cellpadding="20" cellspacing="30" border="0" style="background:#ffffff url(images/page.gif);text-align:left;line-height:20px;">
                        ...
                        <tr>
                            <td>Student Name</td>
                            <td><?php echo htmlspecialchars_decode($r['city'],ENT_QUOTES); ?></td>
                        </tr>
                        <tr>
                            <td>Student Phone</td>
                            <td><?php echo htmlspecialchars_decode($r['contactno'],ENT_QUOTES); ?></td>
                        </tr>
                        <tr>
                            <td>Test</td>
        ...
        <?php
              ...
              <button type="button" value="Print" onclick="javascript:printDiv('print')"  style="width:250px; font-size:30px; color:red;" />PRINT RESULT</button> 
