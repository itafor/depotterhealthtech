...
<?php require("includes/header.php"); ?>  
                ...
                <div class="menubar">
                    ...
                    <ul id="menu">
                        ...
                        // Navigations
                            ...
                            ?>
                           <li><button style="height:40px; width:100px; text-decoration:none; color:white;" class="subbtn" ><a href="../admViewresult.php" target="_blank">View Result</a></button></li>
                             <li><button style="height:40px; width:100px; text-decoration:none; color:white;" class="subbtn"><a href="admViewCandidates.php" target="_blank"">Candidates</a></button></li>      
 ...
 // Defualt Mode: Displays the Detailed Test Results.
        ...
        <?php
              ...
              <button type="button" value="Print" onclick="javascript:printDiv('print')"  style="width:100px; font-size:30px; color:red;" />PRINT</button> 
