        ...
        if (is_numeric($variable)) { //it is because, some session values are also passed with request
            ...
            if (!@executeQuery("delete from test where testid=$variable")) {
                if (mysqli_errno ($conn) == 1451) //Children are dependent value
                    $_GLOBALS['message'] = "To Prevent accidental deletions, system will not allow propagated deletions.<br/><b>Help:</b> If you still want to delete this test, then first delete the questions that are associated with it.";
                else
...
?>
                        ...
                        <tr>
                            ...
                            <td><div class="help"><b>Note:</b>Duration is in minutes, </br> 1hr=60mins <br> just enter 60 for 1hr, 120 for 2hrs e.t.c </div></td>
                        </tr>
                        <tr>
                            <td>Test From </td>
