...
<?php include("includes/header.php"); ?>
 ...
 <div class="frontContent">
    ...
    || $lga=="" || $gender=="" || $dob=="" || $religion=="" || $maritalStatus=="" || $faculty=="" || $dept=="" || $level=="" || $matricno=="" || $password=="" || $confirm_pass=="" || $nkname=="" || $nkphone=="" || $nkaddress=="" ){
    $failure = "<spand style='color: red;'>" ."please fill out all fields". "</span>";
       ...
       faculty,dept,discipline,level,matricno,password,nokname,nokphone,nokaddress,user_status,user_type,regdate)
        ...
        '$faculty','$dept','0','$level','$matricno','$password','$nkname','$nkphone','$nkaddress','Inactive','user','$date')");
        if(!$register){
   ...
   <option value="divorced">Divorced</option>
        ...
        <div class="form-group"> 
            DEPARTMENT:<span style="color:red">*</span> 
                <select id="faculty" type="text" name="faculty"  class="form-control col-lg-12 col-md-12 col-sm-4 col-xs-12" style=" height:40px;" required="required">
 ...
 ?>
        ...
        <div class="form-group"> 
            PROGRAMME:<span style="color:red">*</span> 
                <select id="dept" type="text" name="dept" class="form-control col-lg-12 col-md-12 col-sm-4 col-xs-12" style=" height:40px;" required="required">
 ...
 $rowCount=$query->num_rows;
  ...
  while($row=$query->fetch_assoc()){ 
   echo '<option value= "'.$row['name'].'">'.$row['name'].'</option>';
     ...
     echo '<option value="">programme  not found </option>';
   }
 ?>
  </select> 
  </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
             NEXT OF KIN'S FULL NAME:<span style="color:red">*</span>
            ...
            <div class="col-md-4">
                <div class="form-group">
                NEXT OF KIN'S PHONE:<span style="color:red">*</span>
         ...
         <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                 NEXT OF KIN'S ADDRESS:<span style="color:red">*</span>
