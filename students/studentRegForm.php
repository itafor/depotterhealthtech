...
<?php include("includes/header.php"); ?>
 ...
 <div class="frontContent">
    ...
    $failure = "<spand style='color: red;'>" ."please fill out all fields". "</span>";
       ...
       faculty,dept,discipline,level,matricno,password,nokname,nokphone,nokaddress,user_status,user_type,regdate,picture)
        VALUES('','$surname','$middlename','$lastname','$email','$phone','$address','$state','$lga','$gender','$dob','$religion','$maritalStatus',
        '$faculty','$dept','$course','$level','$matricno','$password','$nkname','$nkphone','$nkaddress','Inactive','user','$date','n')");
        if(!$register){
            ...
            <div class="col-md-4">
                <div class="form-group">
                   DEPARTMENT:<span style="color:red">*</span>
                    <input id="form_name" type="text" name="faculty" class="form-control" placeholder="Please enter your dept *"  data-error="Firstname is required." value="<?php echo isset($_POST['faculty']) ? $_POST['faculty'] : '' ?>">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                   PROGRAMME:<span style="color:red">*</span>
                    <input id="form_name" type="text" name="dept" class="form-control" placeholder="Please enter your programme *"  data-error="Firstname is required." value="<?php echo isset($_POST['dept']) ? $_POST['dept'] : '' ?>">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="col-md-4">
