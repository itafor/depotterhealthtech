...
<?php include("includes/connection.php"); ?>
 ...
 <?php include("includes/studentMenu.php"); ?>
   ...
   <h4 class="page-head-line">DROP REGISTERED COURSES FORM</h4>                    
            ...
            <div class="col-md-6">
                <div class="form-group">
                   MATRIC NUMBER:<span style="color:red">*</span>
                    <input id="form_name" type="text" name="matricno" class="form-control" value="<?php echo $_SESSION['matricno'];?>"  readonly="readonly"  data-error="Firstname is required.">
