...
<a href="index.php"><img src="https://kodelicious.000webhostapp.com/depotterhealthTech/DP/students/images/logo.png" class="img-responsive" alt="MY PROFILE" width="150" height="150"></a>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  EMAIL:<span style="color:red">*</span>
                    <input  type="text" name="email" class="form-control" placeholder="Please enter your email address here to continue" value="<?php echo isset($_POST['email']) ? $_POST['email'] : '' ?>" >
