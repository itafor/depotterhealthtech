...
?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                                            ...
                                            <a href="removecourse.php?courseRegId=<?php echo $row['CRId']?>" target="_blank" onclick="return confirm('Are you sure you want to remove this course?')">
                            <button  class="btn btn-danger" role="button"><i class="fa fa-remove "></i> REMOVE</button> </a>                                        
...
$sn++; 
 ...
 if(!$failure)              
                     echo '<tr>
                      ...
                      ?>
                      <td><?php echo $initalsum ; ?></td><td></td> 
                    </tr>
