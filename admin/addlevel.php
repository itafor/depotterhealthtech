...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   ...
   <h4 class="page-head-line">Add New Level</h4>                    
...
<form action="addlevel.php" method="post" role="form" >
 <div class="controls">
...
//$connect = mysqli_connect('localhost', 'root', '', 'depotter');
 ...
 ?>
   ...
   <br/>
       <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="form_message">Available levels</label>
 ...
 <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="form_message">LEVEL</label>
                      <input type="text" name="addlev" placeholder="ADD LEVEL" class="form-control" > 
                    <div class="help-block with-errors"></div>
                </div>
            </div>
  </div>  <br/>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                                    <input type="submit" name="addlevel"  value="ADD LEVEL"  class="btn btn-success btn-send">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
        </div>
