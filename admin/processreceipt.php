...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   ...
   <h4 class="page-head-line">PAYMENT RECEIPT PROCESSING FROM</h4> 
            ...
            $failure = "Please enter total amount paid by student";   
               ...
               $checkTransID=mysqli_query($connection,"SELECT * FROM application WHERE code='$transid'");
                 if(mysqli_num_rows($checkTransID) == 0){
                  ...
                  $checkslipno=mysqli_query($connection,"SELECT * FROM application WHERE bankslipno='".$slipno."' ");
                     if(mysqli_num_rows( $checkslipno) >= 1){
                  $failure ="The deposit slip number you entered already exist";
                 }else{   
    ...
    {
   echo "<h3 style='color:red;'>Forbidden Area, Only the main admin can process receipt</h3>"; 
    }else{
        ?>
