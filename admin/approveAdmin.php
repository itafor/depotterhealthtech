...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   ...
   <h4 class="page-head-line">enable or disable Staff</h4>
    ...
    {
 echo "<h3 style='color:red;'>Forbidden Area, Only the main admin can Enable or Disable Staff</h3>";   
    }else{
        ?>
   ...
   while($row=mysqli_fetch_array($query))
                         {
                            ...
                            <tr>
                                              ...
                                              <td><?php echo "<img src='$picture' width='70' height='70' alt=\"My profile picture\">" ;?></td>  
