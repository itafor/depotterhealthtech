...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   <h4 class="page-head-line">Add New Assistant Admin</h4> 
  <?php 
    ...
    $erro= "please fill out all fields";
        ...
        $body= "Hello $usernam,\n\n you have been added as an Assistant Admin on de-potter website and need to confirm your email address.Click on the link below or past it into the URL bar of your browser to confirm your email ,Please note that this account may be disabled as soon as you are done with the task given to you by the admin \n\n https://depotterhealthtech.sch.ng/admin/activate.php?code=$code\n\n";
...
$erro = "<p>" . $mail->getMessage() ."we couldn't sign you up at this time. pls try again later". "</p>";
 ...
 $register=mysqli_query($connection,"INSERT INTO admin(id,fullname,email,username,password,phone,picture,code,active,regdate,user_status,rank)
        VALUES('','$fullname','$email','$usernam','$pass','$phone','n','$code','0','$date','Active','subadmin')");
        if(!$register)
        echo " sign up failed".mysqli_error($connection);    
       else
        $success = "you have successfully added an Assistant Admin! Tell him/her to login into this email ($email) to activate account "; 
}
...
<?php 
    ...
    {
  ?>
<form action="newAdmin.php" method="post" role="form">
<div class="controls">  
<div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                   ...
                   <input id="form_name" type="text" name="username" class="form-control" placeholder="Please enter your email *"  data-error="Firstname is required." value="<?php echo isset($_POST['username']) ? $_POST['username'] : '' ?>">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
        </div>
 ...
 echo "<h3 style='color:red;'>Forbidden, Only the main admin can add new assistant Admin </h3>"; 
    }
?>  
