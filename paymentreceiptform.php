 ...
 <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                  Bank deposit No (Teller number):<span style="color:red">*</span>
                    <input id="form_name" type="text" name="bankslipno" class="form-control" placeholder="Please enter teller number to print payment slip" value="<?php echo isset($_POST['email']) ? $_POST['email'] : '' ?>" >
